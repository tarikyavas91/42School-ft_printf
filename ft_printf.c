...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/18 22:42:43 by tyavas            #+#    #+#             */
/*   Updated: 2022/09/18 22:42:43 by tyavas           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_write_printf(char const *src, va_list list)
{
	int		ret;
	char	*str;
...
int	ft_printf(const char *src, ...)
{
	...
	while (src[index])
	{
		if (src[index] == '%')
		{
			ret += ft_write_printf((src + index++), list);
			index++;
		}
		else
		{
